...
import com.shashluchok.medianotes.presentation.toDp
...
private const val tooltipScaleAnimationLabel = "tooltipScaleProgress"
...
fun TooltipContainer(
    ...
    val scale by animateFloatAsState(
        ...
        label = tooltipScaleAnimationLabel
    )
        ...
        if (toolTipVisible) {
            Popup(
                ...
                Surface(
                    ...
                    Box(
                        modifier = Modifier
                            .testTag(tag = Tooltip.Tag.content)
                            .sizeIn(
